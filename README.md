...
- ✅ Customer Count
- ✅ Table Status
- ✅ Order Status Breakdown (Pending, Preparing, Ready, Served)
- ✅ Payments Breakdown (Cash, Card, Wallet)
- ✅ Hourly Revenue Chart
- ✅ Trending Items (Top 10)
...
- 👨‍🍳 Kitchen Load (Timeline)

### Real-Time Metrics
- 🔄 Updates every 30 seconds
- 🔄 Push notifications via WebSocket
- 🔄 Auto-refresh on order completion
- 🔄 Live kitchen load monitoring
...
- `dashboard.refresh` - Dashboard stats updated
